## g1gc tunning
kubectl set env deployment/continuous-editor JDK_JAVA_OPTIONS="-XX:MaxGCPauseMillis=250 -XX:ParallelGCThreads=4 -XX:ConcGCThreads=1 -Xlog:gc*=debug:file=/tmp/gc.log"
